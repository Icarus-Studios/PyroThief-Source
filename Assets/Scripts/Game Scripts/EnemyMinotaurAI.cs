...
public class EnemyMinotaurAI : MonoBehaviour
{
    ...
    [SerializeField] private float rushDelay = 2f;
    ...
    private void MoveCharacter()
    {
        ...
        else
        {
            ...
            if (!isCharging)
            {
                ...
                if (angle > 45f && angle <= 135f)
                {
                    Debug.Log("Rushing up");
                    ChangeAnimationState("ChargeForward");
                    //ChangeAnimationState("RushForward");
                }
                else if (angle > 135f && angle <= 225f)
                {
                    Debug.Log("Running Left");
                ...
                Invoke("ChargeComplete", chargeDelay);
            }
